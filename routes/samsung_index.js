...
var SamsungModel = require("../models/SamsungModel");
...
//    let gas_models = await GasModel.find();
    let samsung_models = await SamsungModel.find();
//    res.render("gas_index.hbs", { models: gas_models });
    res.render("samsung_index.hbs", { models: samsung_models });
...
router.get('/filter', async function (req, res) {
    ...
    res.render("samsung_index.hbs", { models: filtered_models });
